  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "air_shipments_sub" (
        ...
        CONSTRAINT "uq_air_shipments_sub_to_number" UNIQUE ("lt_number", "to_number")
      );

      CREATE INDEX "idx_air_shipments_sub_to_number"   ON "air_shipments_sub" ("lt_number", "to_number");
