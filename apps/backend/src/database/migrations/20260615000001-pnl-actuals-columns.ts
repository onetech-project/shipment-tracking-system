...
//
// Body mirrors 20260605000002 (withBasis=true) — the only change is the extra base/output columns
// guarded by `withActuals` (lt_number + settlement actuals + revenue variance). chwt_awb is added
// later in 20260615000002 (kept separate so it can be applied to DBs that already ran this one).
